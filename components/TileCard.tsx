...
/**
 * Measured off the reference: the focused tile's arrow strip sits below the
 * square art rather than covering it, and runs about 23% of the art's height.
 */
    ...
    >
      ...
      {focused && (
        <motion.span
          ...
          style={{ height: bar }}
          className="flex w-full shrink-0 items-center justify-center bg-[linear-gradient(180deg,rgba(52,116,208,0.95)_0%,rgba(38,92,178,0.95)_100%)]"
        >
          <ChevronIcon
            strokeWidth={2.25}
            className={[
              "h-5 w-5 text-white transition-transform duration-300 ease-console",
